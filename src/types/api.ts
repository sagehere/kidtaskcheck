...
export type TaskSet = Record<string, any> & { id: string; title: string; description: string; taskIds: string[]; members: any[]; eligibleChildIds: string[]; minPoints: number; maxPoints: number };
...
export type ConfigGroupSummary = { id: string; name: string; is_active: number; activated_at?: string | null; created_at: string; updated_at: string; summary: { categories: number; tasks: number; taskSets?: number; rewards: number; achievements: number; feedbackTemplates: number }; applied?: Record<string, number> };
...
export type Notification = { id: string; title: string; body: string; event_type?: string; related_type?: string | null; related_id?: string | null; requires_ack?: number; requiresCompletionSelection?: boolean; read_at: string | null; created_at: string; sourceLabel?: string; sourceTypeLabel?: string; actorLabel?: string };
